...
router.put('/verify-voter/:userId', adminController.verifyVoter);
router.put('/verify-event/:eventId', adminController.verifyEvent);
...
router.put('/change-election-state', adminController.changeElectionState);
